...
\setsansfont{OpenSans-Light.ttf}[
	Path = src/fonts/,
...
%  	\draw [draw=black, fill=white, line width=.6mm] ([xshift=0.03cm,yshift=5cm]current page.north west) -- ([xshift=-0.32cm,yshift=5cm]current page.north east);
	\draw [draw=black, fill=white, line width=.9mm] ([xshift=0.33cm,yshift=-\paperheight+.2cm]current page.north west) -- ([xshift=-0.32cm,yshift=-\paperheight+.2cm]current page.north east);
	\draw [draw=black, fill=white, line width=.9mm] ([xshift=0.33cm,yshift=-.3cm]current page.north west) -- ([xshift=-0.32cm,yshift=-.3cm]current page.north east);
\end{tikzpicture}
...
\url{facebook.com/freiraumpetersburg}
\end{footnotesize}
\end{center}
